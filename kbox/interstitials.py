...
class InterstitialGenerator:
    ...
    def generate_idle_screen(
        ...
        message: str = "Add songs to get started!"
    ) -> str:
        """
        ...
        self._center_text(draw, "Karaoke", self.height // 4 + 140, subtitle_font, SECONDARY_TEXT_COLOR)
    ...
    def generate_end_of_queue_screen(
        self,
        web_url: Optional[str] = None,
        message: str = "That's all for now!"
    ) -> str:
        """
    ...
    def _generate_fallback_image(self, screen_type: str) -> str:
        ...
        output_path = os.path.join(self.cache_dir, f'interstitial_{screen_type}.png')
